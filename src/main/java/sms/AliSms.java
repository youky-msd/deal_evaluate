...
//初始化ascClient,暂时不支持多region（请勿修改）
    ...
    public static boolean sendSms(String mobiles, String content)  {
        ...
        try {
            ...
            System.out.println("{\"time\":\""+orderId+"\", \"content\":\""+ruleId+"\"}");
            //设置超时时间-可自行调整
            ...
            request.setTemplateCode("SMS_146809106");
            //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
            //友情提示:如果JSON中需要带换行符,请参照标准的JSON协议对换行符的要求,比如短信内容中包含\r\n的情况在JSON中需要表示成\\r\\n,否则会导致JSON在服务端解析失败
            request.setTemplateParam("{\"orderId\":\""+orderId+"\", \"ruleId\":\""+ruleId+"\"}");
...
//请求成功
    ...
    public static void main(String[] args) throws ClientException {
        String error="hahah";
        System.out.println("{\"time\":\""+error+"\", \"content\":\""+error+"\"}");
        //设置超时时间-可自行调整
//        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
//        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
//
...
//        request.setSignName("MusicPlayer");
//        //必填:短信模板-可在短信控制台中找到，发送国际/港澳台消息时，请使用国际/港澳台短信模版
//        request.setTemplateCode("SMS_146800365");
//        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
//        //友情提示:如果JSON中需要带换行符,请参照标准的JSON协议对换行符的要求,比如短信内容中包含\r\n的情况在JSON中需要表示成\\r\\n,否则会导致JSON在服务端解析失败
//        request.setTemplateParam("{\"time\":\"Tom\", \"content\":\""+error+"\"}");
//        //可选-上行短信扩展码(扩展码字段控制在7位或以下，无特殊需求用户请忽略此字段)
//        //request.setSmsUpExtendCode("90997");
//        //可选:outId为提供给业务方扩展字段,最终在短信回执消息中将此值带回给调用者
//        request.setOutId("yourOutId");
